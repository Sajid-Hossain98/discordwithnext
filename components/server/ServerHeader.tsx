  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-56 text-sm font-medium text-black dark:text-neutral-400 space-y-[2px]">
        {isModerator && (
          <DropdownMenuItem className="text-indigo-600 dark:text-indigo-400 px-3 py2 text-sm cursor-pointer">
            Invite People
        ...
        {isAdmin && (
          <DropdownMenuItem className="text-rose-500 hover:text-rose-300 px-3 py2 text-sm cursor-pointer">
            Delete Server
